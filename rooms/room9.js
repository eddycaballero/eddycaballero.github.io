var room9state = { 
                create: function() {
                    ...
                    ledge = platforms.create(900, 300, 'platforms');
                    ledge.scale.setTo(3, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(600, 600, 'platforms');
                    ledge.scale.setTo(3, 0.25);
                    ledge.body.immovable = true;

                    goal = game.add.sprite(950,325,'flag');
                    ...
                    //player
                    player.playerBody = game.add.sprite(50, 100, 'player',0);
