var room7state = { 
                create: function() {
                    ...
                    game.world.setBounds(0, 0, 3600, 2000);
                    ...
                    ground.scale.setTo(45, 1);
                    ground.body.immovable = true;
                    
                    var ceiling = platforms.create(0, 0, 'platforms');
                    ceiling.scale.setTo(45, 0.25);
                    ceiling.body.immovable = true;
                    
                    var wall = platforms.create(0,0,'platforms');
                    wall.scale.setTo(3,36);
                    wall.body.immovable = true;
                    
                    wall = platforms.create(3500,0,'platforms');
                    wall.scale.setTo(0.25,36);
                    wall.body.immovable = true;

                    ledge = platforms.create(3000, 1750, 'platforms');
                    ledge.scale.setTo(3, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(3200, 1500, 'platforms');
                    ledge.scale.setTo(3, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(2800, 1600, 'platforms');
                    ledge.scale.setTo(5, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(2300, 1500, 'platforms');
                    ledge.scale.setTo(7, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(1600, 1300, 'platforms');
                    ledge.scale.setTo(6, 0.25);
                    ledge.body.immovable = true;
                    
                    ledge = platforms.create(1500, 1100, 'platforms');
                    ledge.scale.setTo(3, 0.25);
                    ledge.body.immovable = true;

                    goal = game.add.sprite(1500,1100,game.world.height-75,'flag');
                    ...
                    //player
                    player.playerBody = game.add.sprite(1778, 100, 'player',0);
